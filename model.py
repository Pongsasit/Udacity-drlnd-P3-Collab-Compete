...
class Actor(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, seed=10, fc1_units=400, fc2_units=300):
...
class Critic(nn.Module):
    ...
    def __init__(self, input_dim, action_size, seed=10, fcs1_units=400, fc2_units=300):
        """Initialize parameters and build model.
        Params
        ======
            input_dim (int): Input dimension (Dimension of each state)
